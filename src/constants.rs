...
pub mod ascii {
 ...
 .----------------.  .----------------.  .----------------.  .----------------.  .----------------.  .----------------.  .----------------.  .----------------.  .----------------.  .----------------.  .----------------. 
 | .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. |
 | |  ________    | || |     ____     | || |     ______   | || |  _________   | || |     ____     | || |  _______     | || |      __      | || |  _________   | || |  _________   | || |  _______     | || |    _______   | |
 | | |_   ___ `.  | || |   .'    `.   | || |   .' ___  |  | || | |  _   _  |  | || |   .'    `.   | || | |_   __ \    | || |     /  \     | || | |  _   _  |  | || | |_   ___  |  | || | |_   __ \    | || |   /  ___  |  | |
 | |   | |   `. \ | || |  /  .--.  \  | || |  / .'   \_|  | || | |_/ | | \_|  | || |  /  .--.  \  | || |   | |__) |   | || |    / /\ \    | || | |_/ | | \_|  | || |   | |_  \_|  | || |   | |__) |   | || |  |  (__ \_|  | |
 | |   | |    | | | || |  | |    | |  | || |  | |         | || |     | |      | || |  | |    | |  | || |   |  __ /    | || |   / ____ \   | || |     | |      | || |   |  _|  _   | || |   |  __ /    | || |   '.___`-.   | |
 | |  _| |___.' / | || |  \  `--'  /  | || |  \ `.___.'\  | || |    _| |_     | || |  \  `--'  /  | || |  _| |  \ \_  | || | _/ /    \ \_ | || |    _| |_     | || |  _| |___/ |  | || |  _| |  \ \_  | || |  |`\____) |  | |
 | | |________.'  | || |   `.____.'   | || |   `._____.'  | || |   |_____|    | || |   `.____.'   | || | |____| |___| | || ||____|  |____|| || |   |_____|    | || | |_________|  | || | |____| |___| | || |  |_______.'  | |
 | |              | || |              | || |              | || |              | || |              | || |              | || |              | || |              | || |              | || |              | || |              | |
 | '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' |
  '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------' 
"#;
